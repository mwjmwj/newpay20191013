...
<body>
	<div>
		<form class="layui-form" id="proxyform">
			...
			<div class="layui-form-item layui-form-pane">
				...
				<div class="layui-input-block">
					<div class="layui-inline">
						<input type="text" name="accountName" placeholder="请输入"
							autocomplete="off" value="${merchantAccount.accountName }"
				...
				<div class="layui-input-block">
					<div class="layui-inline">
						<input type="text" name="mobileNumber" id="mobileNumber"
							...
							value="${merchantAccount.mobileNumber }" class="layui-input"
							style="width: 212px" lay-filter="phone">
					</div>
				</div>
			</div>
			...
			<div class="layui-form-item layui-form-pane">
				...
				<div class="layui-input-inline">
					<input type="text" name="pas" lay-verify="required" id="passWord"
						placeholder="请输入" autocomplete="off"
						value="${merchantAccount.passWord }" class="layui-input"
						style="width: 212px" lay-filter="password"
						onchange="securityPas()">
				</div>
				<div class="layui-form-mid layui-word-aux" style="margin-left: 20px">密码显示为加密密码。</div>
			</div>

			<input type="hidden" id="pass" name="passWord"
				value="${merchantAccount.passWord }" />
				...
				<div class="layui-input-block">
					<div class="layui-inline">
						...
						<input type="text" name="createTime" autocomplete="off"
							value="<fmt:formatDate value='${merchantAccount.createTime}' type='date' pattern='yyyy-MM-dd HH:mm:ss'/>"
