    ...
    <div class="layui-fluid">
		<div class="layui-row layui-col-space15">
				...
				<div class="layui-card">
					<div class="layui-card-header">
						今日交易金额 <span style="float: right; margin-right: 20%;"> <a
							href="<%=basePath %>/view/merchantRechargeList"
			...
			<div class="layui-col-sm6 layui-col-md3">
				<div class="layui-card">
					<div class="layui-card-header">
						账户余额<span class="layui-badge layui-bg-blue layuiadmin-badge">总</span>
					</div>
					<div class="layui-card-body layuiadmin-card-list">
						<p class="layuiadmin-big-font">${merchantFinance.blanceAmount+merchantFinance.fronzeAmount }
						<c:if test="${merchantFinance.blanceAmount ==null }">0</c:if>
						</p>
						<p>
							&nbsp; <span class="layuiadmin-span-color">元 <i
								class="layui-inline layui-icon layui-icon-dollar"></i></span>
			...
			<div class="layui-col-sm6 layui-col-md3">
				<div class="layui-card">
					<div class="layui-card-header">
						冻结金额 <span class="layui-badge layui-bg-cyan layuiadmin-badge">总</span>
					</div>
					<div class="layui-card-body layuiadmin-card-list">

						<p class="layuiadmin-big-font">${merchantFinance.fronzeAmount }
						<c:if test="${merchantFinance.fronzeAmount ==null }">0</c:if>
						</p>
						<p>
							&nbsp; <span class="layuiadmin-span-color">元<i
			...
			<div class="layui-col-sm6 layui-col-md3">
				<div class="layui-card">
					<div class="layui-card-header">
						...
						可结算金额 <span class="layui-badge layui-bg-green layuiadmin-badge">总</span>
					</div>
					<div class="layui-card-body layuiadmin-card-list">
