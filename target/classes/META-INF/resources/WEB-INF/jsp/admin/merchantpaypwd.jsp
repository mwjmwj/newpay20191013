		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="password" id="pwd" lay-verify="require|uppwd"
					name="newPassword" placeholder="请输入新支付密码" autocomplete="off"
					class="layui-input">
			</div>
			<div class="layui-form-mid layui-word-aux">新支付密码不可与旧支付密码相同</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="password" id="repwd" name="confirmPassword"
					placeholder="确认新支付密码" autocomplete="off" class="layui-input">
			</div>
		</div>
