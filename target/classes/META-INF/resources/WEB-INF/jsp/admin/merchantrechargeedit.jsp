	...
	<form class="layui-form layui-form-pane">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" readonly="readonly" value="${rechargeorder.orderNumber }" class="layui-input"> 
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" readonly="readonly" value="${rechargeorder.payAmount }" class="layui-input"> 
			</div>
		</div>
