...
<body>
	...
	<script>
		...
		//监听工具条
		table.on('tool(placepaybanktable)', function(obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
			...
			if (layEvent === 'edit') { //查看
    	  	...
    	  	$.ajax({
  			type: 'get',
  			url: '${pageContext.request.contextPath}/merchant/placebindbank/bind/'+data.id,
  			dataType: 'json',
  			async:false,
