		...
		<div class="layui-row layui-col-space15">
				...
				<div class="layui-card">
					<div class="layui-card-header">
						今日交易金额 <span style="float: right; margin-right: 20%;"> <a
							href="<%=basePath %>/managerview/proxy/rechargeorder"
							style="color: #01aaed">查看明细</a>
						</span> <span class="layui-badge layui-bg-blue layuiadmin-badge">日(成功)</span>

					</div>
					<div class="layui-card-body layuiadmin-card-list">
						<p class="layuiadmin-big-font">${todaydata.merchantTodayRechargeAmount  }
						<c:if test="${todaydata.merchantTodayRechargeAmount ==null }">0</c:if>
						</p>
						<p>
			...
			<div class="layui-col-sm6 layui-col-md3">
				<div class="layui-card">
					...
					<div class="layui-card-body layuiadmin-card-list">
						<p class="layuiadmin-big-font">${todaydata.merchantTodayOrderNumber }
						<c:if test="${todaydata.merchantTodayOrderNumber ==null }">0</c:if>
						</p>
						<p>
			...
			<div class="layui-col-sm6 layui-col-md3">
				<div class="layui-card">
					...
					<div class="layui-card-body layuiadmin-card-list">
						...
						<p class="layuiadmin-big-font">${data.merchantAllRechargeAmount }
						<c:if test="${data.merchantAllRechargeAmount ==null }">0</c:if>
						</p>
						<p>
							&nbsp; <span class="layuiadmin-span-color">元<i
								class="layui-inline layui-icon layui-icon-dollar"></i></span>
			...
			<div class="layui-col-sm6 layui-col-md3">
				<div class="layui-card">
					...
					<div class="layui-card-body layuiadmin-card-list">
						...
						<p class="layuiadmin-big-font">${data.merchantAllOrderNumber }
						<c:if test="${data.merchantAllOrderNumber ==null }">0</c:if>
						</p>
						<p>
							&nbsp; <span class="layuiadmin-span-color">笔 <i
								class="layui-inline layui-icon layui-icon-flag"></i></span>
			...
			<div class="layui-col-sm6 layui-col-md3">
				<div class="layui-card">
					...
					<div class="layui-card-body layuiadmin-card-list">
						<p class="layuiadmin-big-font">${finance.blanceAmount }
						<c:if test="${finance.blanceAmount ==null }">0</c:if>
						</p>
						<p>
							&nbsp; <span class="layuiadmin-span-color">元 <i
								class="layui-inline layui-icon layui-icon-dollar"></i></span>
			...
			<div class="layui-col-sm6 layui-col-md3">
				<div class="layui-card">
					...
					<div class="layui-card-body layuiadmin-card-list">
						...
						<p class="layuiadmin-big-font">${finance.fronzeAmount }
						<c:if test="${finance.fronzeAmount ==null }">0</c:if>
						</p>
						<p>
							&nbsp; <span class="layuiadmin-span-color">元<i
			...
			<div class="layui-col-sm6 layui-col-md3">
				<div class="layui-card">
					<div class="layui-card-header">
						...
						<a href="<%=basePath %>/merchant/settle/order/pre"
							style="color: #01aaed">申请结算</a></span>
						商户账户总可结算金额 <span class="layui-badge layui-bg-green layuiadmin-badge">总</span>
					</div>
					<div class="layui-card-body layuiadmin-card-list">
						<p class="layuiadmin-big-font">
						${finance.blanceAmount-finance.fronzeAmount }
						</p>
						<p>
		 	...
		 	<div class="layui-col-sm6 layui-col-md3">
				<div class="layui-card">
					<div class="layui-card-header">
						代理费率 <span class="layui-badge layui-bg-orange layuiadmin-badge">当前</span>
					</div>
					<div class="layui-card-body layuiadmin-card-list">

						<p class="layuiadmin-big-font">${paytype.rate }</p>
						<p>
							&nbsp; <span class="layuiadmin-span-color">/1000 <i
								class="layui-inline layui-icon layui-icon-dollar"></i></span>
						</p>
					</div>
				</div>
			...
			<div class="layui-col-sm6 layui-col-md3">
				<div class="layui-card">
					...
					<span style="float: right; margin-right: 12%;">
						<a href="<%=basePath %>/merchant/settle/order/pre"
							style="color: #01aaed">申请结算</a></span>
						可用余额: <span class="layui-badge layui-bg-orange layuiadmin-badge">当前</span>
					</div>
					<div class="layui-card-body layuiadmin-card-list">

						<p class="layuiadmin-big-font">${wefinance.blanceAmount }</p>
						<p>
