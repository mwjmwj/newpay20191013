...
//
//public class HYPayChannel implements IPayChannel {
//
//	private final static Logger log = LoggerFactory.getLogger(HYPayChannel.class);
//
//	@Override
//	public void sendRedirect(Map<String, Object> param, HttpServletResponse response, HttpServletRequest request) {
//
//		String AuthorizationURL = "http://155.138.196.12/Pay_Index.html";
//
//		Map<String, String> para = Maps.newHashMap();
//
//		String merchantId = "190646800";
//
...
//
//		String pay_notifyurl = "http://39.109.4.205/getway/hy/recharge/back";//  回调地址
...
//
//		String url = "http://155.138.196.12/Payment_Dfpay_add.html";
//
//		log.info("gz pay=>" + par);
...
//		String url = "http://155.138.196.12/Payment_Dfpay_query.html";
//
//		Map param = Maps.newHashMap();
//		String pay_memberid = "190646800";
//		param.put("mchid", pay_memberid);
//
//		String out_trade_no = orderNumber;
//		param.put("out_trade_no", out_trade_no);
//
//		String pay_md5sign = MD5.md5("mchid="+pay_memberid+"&out_trade_no="+out_trade_no+"&key=q7o148nvzpc49iqhc4gx9thewazkmee5").toUpperCase();
