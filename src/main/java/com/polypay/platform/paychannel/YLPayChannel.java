...
//
//public class YLPayChannel implements IPayChannel {
//
//	private final static Logger log = LoggerFactory.getLogger(YLPayChannel.class);
//
//	@Override
//	public void sendRedirect(Map<String, Object> param, HttpServletResponse response, HttpServletRequest request) {
//
//		String AuthorizationURL = "http://185.23.201.138/Pay_Index.html";
//
//		Map<String, String> para = Maps.newHashMap();
//
//		String merchantId = "190725082";
//
//		String keyValue = "wg30u8o0l96bdaypwu3cl0zam4qzpovw";
//
...
//
//		String pay_notifyurl = "http://39.109.4.205/getway/yl/recharge/back";//  回调地址
...
//
//		String url = "http://185.23.201.138/Payment_Dfpay_add.html";
//
//		log.info("gz pay=>" + par);
...
//		}
//
//		sb.append("key=wg30u8o0l96bdaypwu3cl0zam4qzpovw");
...
//		String url = "http://185.23.201.138/Payment_Dfpay_query.html";
//
//		Map param = Maps.newHashMap();
//		String pay_memberid = "190725082";
//		param.put("mchid", pay_memberid);
//
//		String out_trade_no = orderNumber;
//		param.put("out_trade_no", out_trade_no);
//
//		String pay_md5sign = MD5.md5("mchid="+pay_memberid+"&out_trade_no="+out_trade_no+"&key=wg30u8o0l96bdaypwu3cl0zam4qzpovw").toUpperCase();
