...
//
//public class XRTPayChannel implements IPayChannel {
//
//	private final static Logger log = LoggerFactory.getLogger(XRTPayChannel.class);
//
//	@Override
//	public void sendRedirect(Map<String, Object> param, HttpServletResponse response, HttpServletRequest request) {
//
//		String AuthorizationURL = "https://www.xinruitai.org/Pay_Index.html";
//
//		Map<String, String> para = Maps.newHashMap();
//
//		String merchantId = "10102";
//
//		String keyValue = "wfjketlgxwj3okwub55drfi6oaplajqo";
//
...
//
//		String pay_notifyurl = "http://39.109.4.205/getway/xrt/recharge/back";//  回调地址
...
//
//		String url = "https://www.xinruitai.org/Payment_Dfpay_add.html";
//
//		log.info("gz pay=>" + par);
...
//		}
//
//		sb.append("key=wfjketlgxwj3okwub55drfi6oaplajqo");
...
//		String url = "https://www.xinruitai.org/Payment_Dfpay_query.html";
//
//		Map param = Maps.newHashMap();
//		String pay_memberid = "10102";
//		param.put("mchid", pay_memberid);
//
//		String out_trade_no = orderNumber;
//		param.put("out_trade_no", out_trade_no);
//
//		String pay_md5sign = MD5.md5("mchid="+pay_memberid+"&out_trade_no="+out_trade_no+"&key=wfjketlgxwj3okwub55drfi6oaplajqo").toUpperCase();
